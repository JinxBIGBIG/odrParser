...
class TrackCoord
{
    protected:
        ...
        */
        int         mTrackId;
        std::string mTrackIdAsString;   // added in version 1.4.5
        bool        mStringDefined;     // added in version 1.4.5
        double      mS;
        double      mT;
        double      mZ;
        double      mH;
    ...
    public:
        ...
        *   @param  r       roll
        */
        explicit TrackCoord( const std::string & track,
                             const double & s, const double & t, 
                             const double & z = 0.0, const double & h = 0.0,
                             const double & p = 0.0, const double & r = 0.0 );
        ...
        *   @version 1.4.5
        */
        const std::string & getTrackIdAsString() const;
        ...
        *   @version 1.4.5
        */
        void setTrackId( const std::string & value );
        ...
        */
        ...
        /**
        * was the ID defined as string?
        * @return true if string id was defined, not numeric id
        * @version 1.4.5
        */
